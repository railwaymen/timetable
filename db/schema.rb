...
ActiveRecord::Schema.define(version: 2021_03_05_172117) do
  ...
  create_table "hardware_device_accessories", force: :cascade do |t|
    ...
    t.bigint "hardware_device_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["hardware_device_id"], name: "index_hardware_device_accessories_on_hardware_device_id"
  end

  create_table "hardware_devices", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.datetime "discarded_at"
    t.index ["discarded_at"], name: "index_hardware_devices_on_discarded_at"
