...
RSpec.describe RemoteWorkForm do
  describe '#validations' do
    it 'validates_date' do
      remote_work_params = attributes_for(:remote_work, starts_at: Time.zone.now, ends_at: 2.days.ago)
      form = RemoteWorkForm.new(remote_work_params)
    ...
    it 'validates_hours' do
      ...
      remote_work_params = attributes_for(:remote_work, starts_at: starts_at, ends_at: starts_at - 1.hour)
      form = RemoteWorkForm.new(remote_work_params)
