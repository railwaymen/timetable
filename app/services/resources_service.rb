...
class ResourcesService
  ...
  def create_resource_group(params)
    ...
    Resource.create(params.merge(rid: rid, parent_rid: parent_rid, resource_id: parent_id))
  end
  ...
  def create_resource(params)
    ...
    resource = Resource.create(params.merge(name: user.to_s, rid: rid, parent_rid: parent_rid, resource_id: parent_id))
  ...
  def create_vacation_events(resource, user)
    ...
    user.vacations.each do |vacation|
      ...
      Event.create(user_id: user.id, project_id: vacation_project.id, resource_id: resource.id, resource_rid: resource.rid, vacation_id: vacation.id,
