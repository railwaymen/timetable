        ...
        <div className="timer">
          <div className="segment ui">
            <div className="field">
              ...
              <div className="date">
                <DatePicker className="datepicker" locale="pl" value={moment(date, 'DD/MM/YYYY').format('DD/MM')} format="DD/MM" dateFormat="DD/MM" onChange={this.onDateChange} onSelect={this.onDateChange}/>
              </div>
